...
public class EduTransactionController {
    ...
    public NexacroResult transactionSelect(@ParamDataSet(name="dsSearch", required=false) Map<String,String> searchMap, 
...
//    public NexacroResult selectVo(@ParamDataSet(name = "ds_search", required = false) SampleVO searchVo) {
	...
	public NexacroResult selectCommCode(Map<String,Object> searchMap, @ParamVariable(name="codeGroup") String codeGroup){
    	...
    	List<Map<String,Object>> resultList = eduTransactionService.selectCommCode(searchMap);
