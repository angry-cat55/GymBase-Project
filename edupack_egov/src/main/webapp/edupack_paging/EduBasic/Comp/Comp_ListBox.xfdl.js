(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Comp_ListBox");
            ...
            obj = new ListBox("ListBox00","20","157","180","110",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("Static05","259.00","287","142","26",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("※ data bind - ds_data");
            obj.set_cssclass("sta_WF_GuideRefer");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01","260.00","313","230","106",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            ...
            obj = new Static("Static08","21.00","458","478","35",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("multi select");
            obj.set_cssclass("sta_WF_GuideTitle2");
            this.addChild(obj.name, obj);

            obj = new Static("Static09","21.00","493","470","36",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("[Property] multiselect = \"true\" | \"false\"");
            obj.set_cssclass("sta_WF_GuideScript");
            this.addChild(obj.name, obj);

            obj = new Static("Static10","21","529","175","26",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("multiselect = \"true\"");
            obj.set_cssclass("sta_WF_GuideRefer");
            this.addChild(obj.name, obj);

            obj = new ListBox("ListBox2","21.00","555","180","110",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_innerdataset("ds_code");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("NAME");
            ...
            obj = new Static("Static11","530.00","60","332","35",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("index, value, text");
            obj.set_cssclass("sta_WF_GuideTitle2");
            this.addChild(obj.name, obj);

            obj = new Static("Static12","530.00","95","470","36",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            ...
            obj = new Button("Button04","530.00","229","188","26",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_text("text");
            obj.set_positionstep("0");
            obj.set_cssclass("btn_WF_GuideExec");
            ...
            obj.set_taborder("21");
            obj.set_text("id = ListBox1");
            obj.set_cssclass("sta_WF_GuideRefer");
            this.addChild(obj.name, obj);

            obj = new ListBox("ListBox1","798","157","180","110",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_innerdataset("ds_code");
            obj.set_codecolumn("CODE");
            obj.set_datacolumn("NAME");
            ...
            obj = new TextArea("txt_desc1","530.00","274","470","80",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_positionstep("0");
            ...
            obj = new Static("Static13","530.00","458","448","35",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("selected item");
            obj.set_cssclass("sta_WF_GuideTitle2");
            this.addChild(obj.name, obj);

            obj = new Static("Static14","530.00","493","470","36",null,null,null,null,null,null,this);
            obj.set_taborder("25");
            obj.set_text("[Method] getSelectedCount(), getSelectedItems()");
            obj.set_cssclass("sta_WF_GuideScript");
            this.addChild(obj.name, obj);

            obj = new Button("Button09","530.00","534","152","26",null,null,null,null,null,null,this);
            obj.set_taborder("26");
            ...
            obj = new Button("Button10","530.00","565","152","26",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            ...
            obj = new TextArea("txt_desc2","530.00","596","470","80",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_positionstep("0");
            obj.set_cssclass("txt_WF_GuideDesc");
            obj.set_readonly("true");
            ...
            obj = new BindItem("item0","ListBox00","value","ds_data","CODE");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","ListBox01","value","ds_data","DAY");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        {
        	this.fn_result(obj, this.ListBox1, this.txt_desc1);
        };

        this.fn_exec2 = function(obj,e)
        {
        	this.fn_result(obj, this.ListBox2, this.txt_desc2);
        };
