(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("Form_ScriptSample2.xfdl","Lib::Lib_Util.xjs");
        this.addIncludeScript("Form_ScriptSample2.xfdl","Lib::Lib_Grid.xjs");
        this.addIncludeScript("Form_ScriptSample2.xfdl","Lib::Lib_Comm.xjs");
        this.registerScript("Form_ScriptSample2.xfdl", function() {
        ...
        this.loadIncludeScript("Form_ScriptSample2.xfdl");
