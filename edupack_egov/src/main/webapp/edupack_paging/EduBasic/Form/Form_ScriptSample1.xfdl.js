(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("Form_ScriptSample1.xfdl", function() {
        ...
        this.Form_onload = function(obj,e)
        {
        	...
        	this.div_search.form.cal_from.value = sYear+sMonth+"01";
        	this.div_search.form.cal_to.value = sYear+sMonth+sDay;

        	// 코드 데이터 가져오기 - 직급, 재직상태
        	// 직급
            var sSvcID    = "svcCodePosition";
            var sURL      = "http://localhost:8088/edupack_egov/edu/edupack24_jsp/getCodePosition.jsp";
            var sInDs     = "";
        	...
        	// 재직상태
            var sSvcID    = "svcCodeStatus";
            var sURL      = "http://localhost:8088/edupack_egov/edu/edupack24_jsp/getCodeStatus.jsp";
            var sInDs     = "";
            var sOutDs    = "ds_status=out_status";
            var sParam    = "";
            var sCallBack = "fn_callback";
        	this.transaction(sSvcID, sURL, sInDs, sOutDs, sParam, sCallBack, false);//동기 통

        	//재직상태 '전체' 표현
        	this.ds_status.insertRow(0);
        	this.ds_status.setColumn(0, "CODE", "ALL");
        	this.ds_status.setColumn(0, "NAME", "전체");

        	// 재직상태 '전체' 선택
        	this.div_search.form.rdo_status.value = "ALL";
        ...
        this.btn_search_onclick = function(obj,e)
        {
            ...
            var sURL      = "http://localhost:8088/edupack_egov/edu/edupack24_jsp/getEmpList.jsp";
            var sInDs     = "";
            ...
            var sURL      = "EduBasic::getEmpAppoint.jsp";
            var sInDs     = "";
        ...
        this.btn_save_onclick = function(obj,e)
        {
            ...
            var sURL      = "http://localhost:8088/edupack_egov/edu/edupack24_jsp/saveEmp.jsp";
        ...
        this.grd_emp_oncellclick = function(obj,e)
        {
            ...
            var sEmpID = this.ds_emp.getColumn(this.ds_emp.rowposition, "EMP_ID");
            var sSvcID    = "svcGetDetail";
            var sURL      = "http://localhost:8088/edupack_egov/edu/edupack24_jsp/getEmpAppoint.jsp";
            var sInDs     = "";
            var sOutDs    = "ds_appoint=out_appoint";
            var sParam    = "pEmpID='" + sEmpID + "'";
            var sCallBack = "fn_callback";
        ...
        this.div_detail_btn_popupDept_onclick = function(obj,e)
        {
        	...
        	objChild.formurl = "http://localhost:8088/edupack_egov/edu/edupack24_jsp/Form/Popup_SearchDept.xfdl";
        ...
        this.loadIncludeScript("Form_ScriptSample1.xfdl");
