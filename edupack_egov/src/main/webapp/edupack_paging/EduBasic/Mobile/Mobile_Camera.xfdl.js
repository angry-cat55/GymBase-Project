(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_camera",null,"20","200","40","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Take a Picture");
            obj.set_cssclass("btn_WF_Camera");
            this.addChild(obj.name, obj);

            obj = new ImageViewer("img_picture","20","80",null,null,"20","20",null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        {
        	this.img_picture.image = e.imagedata;
        };
