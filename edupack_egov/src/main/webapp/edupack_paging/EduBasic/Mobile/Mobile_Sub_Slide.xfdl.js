(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta_barBg","20","75","360","5",null,null,null,null,null,null,this.div_slide.form);
            obj.set_taborder("0");
            obj.set_usedecorate("true");
            obj.set_cssclass("sta_WF_SliderBg");
            this.div_slide.addChild(obj.name, obj);

            obj = new Static("sta_bar","20","75","250","5",null,null,null,null,null,null,this.div_slide.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_Slider");
            this.div_slide.addChild(obj.name, obj);

            obj = new Static("sta_text","236","27","56","30",null,null,null,null,null,null,this.div_slide.form);
            obj.set_taborder("2");
            obj.set_text("0");
            this.div_slide.addChild(obj.name, obj);

            obj = new Static("st_min","20","84","40","30",null,null,null,null,null,null,this.div_slide.form);
            obj.set_taborder("3");
            obj.set_text("0");
            this.div_slide.addChild(obj.name, obj);

            obj = new Static("stMax","339","84","36","30",null,null,null,null,null,null,this.div_slide.form);
            obj.set_taborder("4");
            obj.set_text("99");
            this.div_slide.addChild(obj.name, obj);

            obj = new Button("btn_point","252","65","24","24",null,null,null,null,null,null,this.div_slide.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_WF_SliderPoint");
            this.div_slide.addChild(obj.name, obj);
            // Layout Functions
        ...
        this.fnMove = function(nClientX)
        {
        	...
        	obj.form.sta_text.text = this.fvValue + this.fvLable;
        }
