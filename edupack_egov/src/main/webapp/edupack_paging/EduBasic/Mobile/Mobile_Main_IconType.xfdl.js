(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("1");
            obj.set_text("MENU");
            obj.set_cssclass("btn_MF_Menu");
            this.addChild(obj.name, obj);

            obj = new Button("btn_setting","360",null,"118","70",null,"0",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj.set_cssclass("btn_MF_Mypage");
            this.addChild(obj.name, obj);
            ...
            //-- Default Layout : this.div_menu.form
        ...
        this.fn_menuPop = function(bFlag)
        {
        	if(bFlag)
        	{
        		...
        		this.div_menu.url = "";
        		this.div_menu.url = "EduBasic::Mobile/Mobile_Menu.xfdl";
