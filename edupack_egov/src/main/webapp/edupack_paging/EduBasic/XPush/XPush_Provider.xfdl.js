(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "Chk","type" : "STRING","size" : "256"},{"id" : "TOPIC_ID","type" : "STRING","size" : "256"},{"id" : "TOPIC_NAME","type" : "STRING","size" : "256"}]},"Rows" : [{"TOPIC_ID" : "ALL","TOPIC_NAME" : "전체"},{"TOPIC_ID" : "TOBEEDU01","TOPIC_NAME" : "EDU01"},{"TOPIC_ID" : "TOBEEDU02","TOPIC_NAME" : "EDU02"},{"TOPIC_ID" : "TOBEEDU03","TOPIC_NAME" : "EDU03"},{"TOPIC_ID" : "TOBEEDU04","TOPIC_NAME" : "EDU04"},{"TOPIC_ID" : "TOBEEDU05","TOPIC_NAME" : "EDU05"},{"TOPIC_ID" : "TOBEEDU06","TOPIC_NAME" : "EDU06"}]});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsProvider", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "PROJECT_ID","type" : "STRING","size" : "256"},{"id" : "PUSH_TYPE","type" : "STRING","size" : "256"},{"id" : "TOPIC_TYPE","type" : "STRING","size" : "256"},{"id" : "TOPIC_ID","type" : "STRING","size" : "256"},{"id" : "CODE","type" : "STRING","size" : "256"},{"id" : "MSG","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_Info", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "PROJECT_ID","type" : "STRING","size" : "256"},{"id" : "PROTOCAL_VERSION","type" : "STRING","size" : "256"},{"id" : "ADDRESS","type" : "STRING","size" : "256"},{"id" : "Column0","type" : "STRING","size" : "256"}]},"Rows" : [{"PROJECT_ID" : "TOBE_EDU","PROTOCAL_VERSION" : "3","ADDRESS" : "tcp://localhost:50001, http://localhost:50001","HTML5" : "tcp://172.10.11.14:50001, http://172.10.11.14:50000"}]});
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_topicType", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "CODE","type" : "STRING","size" : "256"},{"id" : "NAME","type" : "STRING","size" : "256"}]},"Rows" : [{"CODE" : "1000","NAME" : "긴급"},{"CODE" : "2000","NAME" : "공지사항"},{"CODE" : "9999","NAME" : "일반 메시지"}]});
            this.addChild(obj.name, obj);


            obj = new Dataset("ds_megType", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "CODE","type" : "STRING","size" : "256"},{"id" : "NAME","type" : "STRING","size" : "256"}]},"Rows" : [{"CODE" : "PUSH","NAME" : "실시간 메시지"},{"CODE" : "RELI","NAME" : "신뢰성 메시지"}]});
            this.addChild(obj.name, obj);
