(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "TOPIC_ID","type" : "STRING","size" : "256"},{"id" : "TOPIC_TYPE","type" : "STRING","size" : "256"},{"id" : "MSG","type" : "STRING","size" : "256"},{"id" : "USER","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsUserList", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "TOPIC_ID","type" : "STRING","size" : "256"},{"id" : "TOPIC_TYPE","type" : "STRING","size" : "256"},{"id" : "USER","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
