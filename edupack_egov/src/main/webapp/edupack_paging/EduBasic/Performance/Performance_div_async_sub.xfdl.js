(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_list","10","60",null,null,"20","45",null,null,null,null,this);
            obj.set_taborder("1");
            obj.getSetter("leftbase").set("");
            obj.getSetter("bottombase").set("");
            obj.getSetter("widthbase").set("");
        ...
        // User Script
        this.registerScript("Performance_div_async_sub.xfdl", function() {
        ...
        this.loadIncludeScript("Performance_div_async_sub.xfdl");
