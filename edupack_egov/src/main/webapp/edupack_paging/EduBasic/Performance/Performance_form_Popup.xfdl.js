(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("Performance_form_Popup.xfdl", function() {
        ...
        this.btn_Exe3_2_onclick = function(obj,e)
        {
        	...
        	var ds = this.removeChild("ds_child");

        	//주의 반드시 넘기고자 하는 ds를 this.removeChild하여 넘겨야 한다.
            //그렇지 한고 바로 ds_child 넘기면 Owner인 폼이 닫히기 때문에 함께 소멸되므로 값 전달이 안된다.

        	this.opener.paramDs = ds;
        ...
        this.loadIncludeScript("Performance_form_Popup.xfdl");
