(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "cnt","type" : "INT","size" : "256"},{"id" : "offset","type" : "INT","size" : "256"}]}});
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divPage","33","grd00:5","930","40",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("div00");
        ...
        {
            this.btnSearc.addEventHandler("onclick",this.btn00_onclick,this);
