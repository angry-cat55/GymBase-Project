(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divWork","0","38",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            ...
            obj.set_text("");
            obj.set_background("#ffffff");
            obj.set_border("0px none,1px solid #d6dee3");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","divNotice.form.staNotice","text","gdsXpushMessage","MSG");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        * FORM EVENT 영역(onload)
        ...
        {
        	this.form_onsize();
        	this.divTitle.form.scrollbartype = "none";
        	...
        	this.divWork.url = (this.getOwnerFrame().arguments["pageUrl"]);

        	// 공통버튼 사용여부
        	if (this.FRAME_IS_COMBTN_USE) this.staLodingTime.visible = false;
