(function()
{
    return function()
    {
        ...
        {
            this.set_name("FrameLeftBar");
            this.set_background("#f3f5f6");
            if (Form == this.constructor)
            {
                this._setFormPosition(40,738);
            }
            ...
            obj = new Button("btnMenu","5","40","30","20",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Button("btnMenuChange","5","10","30","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
        ...
        // User Script
        this.registerScript("FrameLeftBar.xfdl", function() {
        /**
        ...
        */
        ...
        this.btnMenu_onclick = function(obj,e)
        {
        	var nH = this.fvObjApp.avLeftFrame.getOffsetHeight();
         	this.pdivMenu.height = nH;
        	this.pdivMenu.trackPopupByComponent(this.btnMenuChange, -5, -10);
        	...
        	if(this.fvOpenFlag){
        		...
        		this.pdivMenu.form.divLeft.form.btnMenuChange.cssclass = "btn_LF_Pin";
        ...
        this.loadIncludeScript("FrameLeftBar.xfdl");
