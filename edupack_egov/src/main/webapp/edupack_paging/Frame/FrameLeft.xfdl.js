(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "MENU_GROUP","type" : "STRING","size" : "256"},{"id" : "MENU_ID","type" : "STRING","size" : "256"},{"id" : "MENU_PID","type" : "STRING","size" : "256"},{"id" : "MENU_LEVEL","type" : "INT","size" : "256"},{"id" : "MENU_NAME","type" : "STRING","size" : "256"},{"id" : "MENU_NAME_EN","type" : "STRING","size" : "256"},{"id" : "MENU_URL","type" : "STRING","size" : "256"},{"id" : "USE_YN","type" : "STRING","size" : "256"},{"id" : "AUTH","type" : "STRING","size" : "256"},{"id" : "MENU_PATH","type" : "STRING","size" : "256"},{"id" : "SORT_NO","type" : "INT","size" : "256"}]}});
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "Column0","type" : "STRING","size" : "256"},{"id" : "Column1","type" : "STRING","size" : "256"},{"id" : "Column2","type" : "STRING","size" : "256"},{"id" : "Column3","type" : "STRING","size" : "256"}]},"Rows" : [{},{},{},{},{}]});
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divLeft","10","10","228",null,null,"10",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("div00");
            obj.set_cssclass("div_LF_Bg");
            this.addChild(obj.name, obj);

            obj = new Grid("grdMyMenu","0","40",null,null,"0","0",null,null,null,null,this.divLeft.form);
            ...
            obj = new Grid("grdTree","0","40",null,null,"0","0",null,null,null,null,this.divLeft.form);
            obj.set_treeinitstatus("collapse,null");
            obj.set_cssclass("grd_LF_Tree");
            obj.set_autofittype("col");
            obj.set_treeusecheckbox("false");
            ...
            obj = new Button("btnMyMenu","82","0","80","30",null,null,null,null,null,null,this.divLeft.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btnOpenMenuFind","164","0","30","30",null,null,null,null,null,null,this.divLeft.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_LF_Find");
            this.divLeft.addChild(obj.name, obj);

            obj = new Button("btnMenu","0","0","80","30",null,null,null,null,null,null,this.divLeft.form);
            obj.set_taborder("4");
            obj.set_text("Menu");
            obj.set_cssclass("btn_WF_FillTeal");
            this.divLeft.addChild(obj.name, obj);

            obj = new Button("btnMenuChange","196","0","30","30",null,null,null,null,null,null,this.divLeft.form);
            obj.set_taborder("5");
        ...
        */
        this.form_onload = function(obj,e)
        {
        	...
        	this.divLeft.form.btnMenu.setSelectStatus(true);
        ...
        */
        this.fnChangeLang = function()
        {
        	...
        	if (sNowLang != "KO") {
        		...
        		this.pdivMenuSearch.form.edtMenuSearch.displaynulltext = "Search the menu.";
        ...
        */
        this.fnChangeMenu = function (topMenuId)
        {
        	...
        	{
        		this.fvObjApp.avHFrameSet.separatesize = this.fvObjApp.avLeftOpen;
        		if(this.fvObjApp.avLeftBarFrame.form.pdivMenu.isPopup())	this.fvObjApp.avLeftBarFrame.form.pdivMenu.closePopup();
        	}
        	var filterExpr = this.FRAME_MENUCOLUMNS.groupId + " == " + nexacro.wrapQuote(topMenuId) + " && " + this.FRAME_MENUCOLUMNS.menuLevel + "!=0 && USE_YN=='Y'";

        	this.fvObjApp.gdsMenu.enableevent = false;
        	this.dsMenu.enableevent = false;
        	this.fvObjApp.gdsMenu.filter(filterExpr);
        	this.dsMenu.copyData(this.fvObjApp.gdsMenu, true);
        	this.fvObjApp.gdsMenu.filter("");
        	this.fvObjApp.gdsMenu.enableevent = true;
        	this.dsMenu.enableevent = true;
        };
        ...
        this.grdTree_oncellclick = function(obj,e)
        {
        	...
        	if(this.gfnIsNull(sMenuUrl) == false){
        		...
        		if(this.parent.name == "pdivMenu"){
        			this.fvObjApp.avLeftBarFrame.form.pdivMenu.closePopup();
        		}
        	}
        ...
        */
        ...
        {
        	this.divLeft.form.grdTree.visible = true;
        	this.divLeft.form.grdMyMenu.visible = false;

        	this.divLeft.form.btnMenu.setSelectStatus(true);
        	this.divLeft.form.btnMyMenu.setSelectStatus(false);
        };
        ...
        */
        ...
        {
        	this.divLeft.form.grdTree.visible = false;
        	this.divLeft.form.grdMyMenu.visible = true;

        	this.divLeft.form.btnMenu.setSelectStatus(false);
        	this.divLeft.form.btnMyMenu.setSelectStatus(true);
        };
        ...
        */
        ...
        {
        	this.pdivMenuSearch.width = this.divLeft.getOffsetWidth();
        ...
        */
        this.fnSearchMenu = function(sNm)
        {
        	...
        	this.dsPdivMenu.enableevent = false;
        	this.pdivMenuSearch.form.grdMenuSearch.enableredraw = false;

        	this.dsPdivMenu.filter("");
        	sNm = sNm.toLowerCase();
        	this.dsPdivMenu.filter("MENU_NAME.toLowerCase().indexOf('"+sNm+"') > -1 || MENU_NAME_EN.toLowerCase().indexOf('"+sNm+"') > -1");

        	this.dsPdivMenu.enableevent = true;
        	this.pdivMenuSearch.form.grdMenuSearch.enableredraw = true;
        ...
        this.btnMenuChange_onclick = function(obj,e)
        {
        	if(this.fvObjApp.avHFrameSet.separatesize == this.fvObjApp.avLeftOpen){
        		this.fvObjApp.avHFrameSet.separatesize = this.fvObjApp.avLeftClose;
        		this.fvObjApp.avLeftBarFrame.form.fvOpenFlag = true;

        	}
        	else{
        		// Left 고정할경우 PopupDiv 트리 형태로 Left 트리를 변경
        		var nMenuRow = this.fvObjApp.avLeftBarFrame.form.pdivMenu.form.divLeft.form.grdTree.getBindDataset().rowposition;
        		this.fvObjApp.avLeftBarFrame.form.fnTreeStatus(this.fvObjApp.avLeftFrame.form.divLeft.form.grdTree, nMenuRow);
        		this.fvObjApp.avHFrameSet.separatesize = this.fvObjApp.avLeftOpen;
        ...
        this.on_initEvent = function()
        {
            ...
            this.divLeft.form.btnMyMenu.addEventHandler("onclick",this.btnMyMenu_onclick,this);
            this.divLeft.form.btnOpenMenuFind.addEventHandler("onclick",this.btnOpenMenuFind_onclick,this);
            this.divLeft.form.btnMenu.addEventHandler("onclick",this.btnMenu_onclick,this);
            this.divLeft.form.btnMenuChange.addEventHandler("onclick",this.btnMenuChange_onclick,this);
        };
