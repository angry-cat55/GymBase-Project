(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "ID","type" : "STRING","size" : "256"},{"id" : "NAME","type" : "STRING","size" : "256"}]},"Rows" : [{"ID" : "","NAME" : ""}]});
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divSearch","20","staTitle:0",null,"44","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_cssclass("div_WF_Search");
            this.addChild(obj.name, obj);

            obj = new Edit("edtId","108","8","157","26",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtName","381","8","157","26",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01","19","8","89","26",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("아이디");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static00","305","8","76","26",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("3");
            obj.set_text("성명");
            obj.set_cssclass("sta_WF_SchLabel");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta00_00","20","divSearch:0","196","40",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("데이터 목록");
            obj.set_cssclass("sta_WF_Title2");
            this.addChild(obj.name, obj);

            obj = new Grid("grdList","20","sta00_00:0",null,null,"20","20",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_autofittype("col");
            obj.set_binddataset("dsList");
            obj.set_selecttype("row");
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"149\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"아이디\" expandchar=\"user.id\"/><Cell col=\"1\" text=\"명칭\" expandchar=\"designation\"/><Cell col=\"2\" text=\"설명\" expandchar=\"description\"/><Cell col=\"3\" text=\"사용여부\" expandchar=\"useflg\"/><Cell col=\"4\" text=\"등록자\" expandchar=\"reguser\"/></Band><Band id=\"body\"><Cell text=\"bind:ID\" edittype=\"normal\"/><Cell col=\"1\" text=\"bind:NAME\" edittype=\"text\"/><Cell col=\"2\" text=\"bind:DESCRIPTION\" edittype=\"text\"/><Cell col=\"3\" text=\"bind:USE_YN\" edittype=\"text\"/><Cell col=\"4\" text=\"bind:REG_USER\" edittype=\"text\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btnAdd",null,"17","70","26","170",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("입력");
            ...
            obj = new Button("btnDel",null,"17","70","26","95",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("삭제");
            ...
            obj = new Button("btnSave",null,"17","70","26","20",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("저장");
            ...
            obj = new Button("btnExcelEx",null,"112","93","24","119",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Excel export");
            obj.set_cssclass("btn_WF_FillBlueSub");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelImport",null,"112","94","24","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Excel import");
            obj.set_cssclass("btn_WF_FillBlueSub");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelTitle",null,"112","122","24","217",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Excel export(title)");
            obj.set_cssclass("btn_WF_FillBlueSub");
            this.addChild(obj.name, obj);

            obj = new Button("btnGridSize",null,"112","184","24","344",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("데이타 만큼 그리드 크기 조정");
            obj.set_cssclass("btn_WF_FillBlueSub");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch",null,"17","70","26","245",null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("조회");
        ...
        *******************************************************************************
        *  2025/02/14      		 TOBESOFT Education	 	  	최초 생성
        *******************************************************************************
        */
        ...
        */
        this.fnExcel = function(argGrid)
        {
            ...
            objGrid.formats = argGrid.getCurFormatString(false);
            objGrid.formatid = argGrid.formatid;
            objGrid.binddataset = argGrid.binddataset;
        	...
        	*/
        	// Quick View 실행시 file name 꼭 전달 필요
        	// gfnExcelExport(Grid Object, sheet name, file nam);
        	this.gfnExcelExport(objGrid, "sheet1","Transaction Sample");
        ...
        this.btnExcelTitle_onclick = function(obj,e)
        {
        	...
        	objGrid.visible = false;
            objGrid.formats = this.grdList.getCurFormatString(false);
            objGrid.formatid = this.grdList.formatid;
            objGrid.binddataset = this.grdList.binddataset;
            objGrid.visible = false;
        	...
        	// Quick View 실행시 file name 꼭 전달 필요
        	// gfnExcelExport(Grid Object, sheet name, file nam);
        	this.gfnExcelExport(objGrid, "sheet1","Transaction Sample Title");
        //	this.gfnExcelExport(objGrid, "*?*?*?*?*?*?*?","");
        };
        ...
        this.btnGridSize_onclick = function(obj,e)
        {
        	...
        	if (this.grdList.getOffsetHeight() < nHeight) {
        		this.grdList.setOffsetHeight(nHeight);
        	}
