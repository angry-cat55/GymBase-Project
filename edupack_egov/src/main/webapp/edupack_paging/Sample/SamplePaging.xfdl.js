(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1020,680);
            }
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "records","type" : "INT","size" : "256"},{"id" : "page","type" : "INT","size" : "256"},{"id" : "recordsOffset","type" : "INT","size" : "256"},{"id" : "pageCount","type" : "INT","size" : "256"}]}});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsPagingInfo", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "totalCount","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new TextArea("txtDesc","20","60",null,"170","20",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_cssclass("txt_WF_Desc");
            obj.set_value("그리드 페이징 구현 샘플이다.\n1. 페이지가 표현되는 영역에 Div를 생성하고 url을 Cmm::CmmPaging.xfdl 로 지정한다.\n2. 조회조건을 넘길 Dataset을 생성 하여 record, page, recordsOffset, pagecount 값을 설정한다.\n    초기 조회일 경우 page, recordsOffset, pagecount값은 default로 0으로 세팅, records값은 각 회면별 그리드에 표현될 목록수로 세팅\n       this.dsSearch.setColumn(nRow, \"records\", this.fvRecords);\n       this.dsSearch.setColumn(nRow, \"recordsOffset\", this.fvRecordsOffset); \n3. this.divPage.fnCreatePage(this.dsSearch, this.dsList, \"fnSearch\", this.grd00); 를 호출한다");
            this.addChild(obj.name, obj);

            obj = new Div("divSearch","20","txtDesc:20",null,"46","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_cssclass("div_WF_Search");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch",null,"9","60","26","20",null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("조회");
            obj.getSetter("uWord").set("search");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("Static01","20","10","100","26",null,null,"100",null,null,null,this.divSearch.form);
            obj.set_taborder("1");
            obj.set_text("목록갯수");
            ...
            obj = new Combo("cboCnt","120","10","112","26",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("2");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var divSearch_form_cboCnt_innerdataset = new nexacro.NormalDataset("divSearch_form_cboCnt_innerdataset", obj);
            divSearch_form_cboCnt_innerdataset._setContents({"ColumnInfo" : {"Column" : [ {"id" : "codecolumn","size" : "256"},{"id" : "datacolumn","size" : "256"}]},"Rows" : [{"codecolumn" : "2","datacolumn" : "2"},{"codecolumn" : "10","datacolumn" : "10"},{"codecolumn" : "50","datacolumn" : "50"},{"codecolumn" : "100","datacolumn" : "100"}]});
            ...
            obj = new Grid("grd00","20","divSearch:10",null,"332","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("dsList");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"116\"/><Column size=\"104\"/><Column size=\"174\"/><Column size=\"80\"/><Column size=\"96\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"ID\"/><Cell col=\"2\" text=\"NAME\"/><Cell col=\"3\" text=\"DESCRIPTION\"/><Cell col=\"4\" text=\"USE_YN\"/><Cell col=\"5\" text=\"REG_USER\"/></Band><Band id=\"body\"><Cell text=\"bind:ROWNUM\" displaytype=\"text\"/><Cell col=\"1\" text=\"bind:ID\"/><Cell col=\"2\" text=\"bind:NAME\"/><Cell col=\"3\" text=\"bind:DESCRIPTION\"/><Cell col=\"4\" text=\"bind:USE_YN\"/><Cell col=\"5\" text=\"bind:REG_USER\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("divPage","20","grd00:0",null,"30","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            //-- Default Layout : this
            obj = new Layout("default","screen_desktop",1020,680,this,function(p){});
