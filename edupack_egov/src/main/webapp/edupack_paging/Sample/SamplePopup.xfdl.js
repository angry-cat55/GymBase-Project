(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "Column0","type" : "STRING","size" : "256"},{"id" : "Column1","type" : "STRING","size" : "256"}]},"Rows" : [{"Column0" : "1","Column1" : "명칭1"},{"Column0" : "2","Column1" : "명칭2"}]});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Button("btnPopup","20","385","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("모달팝업\r\ncallback-string");
            obj.getSetter("uWord").set("popup.modal");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup00","195","385","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("모달리스 팝업\r\ncallback-string");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup01","516","385","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("팝업에 form 연결\r\ncallback-string");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup02","20","507","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("모달Sync(Runtime)\r");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup03","195","507","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("모달Window(Runtime)");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup04","690","385","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("팝업에 url 연결\r\ncallback-string");
            this.addChild(obj.name, obj);

            obj = new Button("btnClose","20","568","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("모든 팝업 닫기");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup05","20","446","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("모달팝업\r\ncallback-function");
            obj.getSetter("uWord").set("popup.modal");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup06","195","446","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("모달리스 팝업\r\ncallback-function");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup07","691","446","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("팝업에 url 연결\r\ncallback-function");
            this.addChild(obj.name, obj);

            obj = new Button("btnPopup08","516","446","170","56",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("팝업에 form 연결\r\ncallback-function");
            this.addChild(obj.name, obj);
        ...
        */
        ...
        {
        	var sTitle = "모달팝업"; // this.gfnGetWord("popup.modal");	// 모달팝업
        ...
        */
        ...
        this.btnPopup04_onclick = function(obj,e)
        {
        	var sUrl = this.gfnGetServerUrl();
        	    sUrl += "edu/document/jsDoc/index.html";
        	var oArg = {paramUrl:sUrl};
        	var oOption = {popuptype:"modeless",title:"팝업에 url 연결",width:"800",height:"600"};
        	var sPopupCallBack = "fnPopupCallback";
