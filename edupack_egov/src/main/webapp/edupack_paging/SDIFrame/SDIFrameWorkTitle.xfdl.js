(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnSel",null,"5","50","28","277",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("조회");
            ...
            obj = new Button("btnAdd",null,"5","50","28","222",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("입력");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnSav",null,"5","50","28","2",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("저장");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnDel",null,"5","50","28","167",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnExl",null,"5","50","28","112",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("엑셀");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            obj = new Button("btnPrt",null,"5","50","28","57",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("출력");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_visible("false");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1040,38,this,function(p){});
        ...
        // User Script
        this.registerScript("SDIFrameWorkTitle.xfdl", function() {
        /**
        *  Nexacro Professional Training Couse
        *  @MenuPath    SIDFrame > SDIFrameWorkTitle
        *  @FileName 	SDIFrameWorkTitle.xfdl
        *  @Creator 	TOBESOFT Education
        *  @CreateDate 	2025/03/02
        *  @Desction    SDI 업무공통 타이틀
        ************** 소스 수정 이력 ***********************************************
        ...
        */
        ...
        {
        //	trace( this.objApp.avWorkFrame.arguments);
        //	var sTitle = this.objApp.avWorkFrame.arguments["menuPath"];
        //	this.staTitle.text = sTitle;



        //this.fvMenuId = this.objApp.avWorkFrame.arguments["menuId"];
        //	this.fnSetMyMenuBtn();
        ...
        */
        ...
        this.loadIncludeScript("SDIFrameWorkTitle.xfdl");
