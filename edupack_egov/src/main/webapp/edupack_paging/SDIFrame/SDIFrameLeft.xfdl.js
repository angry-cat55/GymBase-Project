(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new PopupDiv("pdivMenuSearch","254","48","200","213",null,null,null,null,null,null,this);
            obj.set_text("pdiv00");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divLeft","0","0","228",null,null,"0",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("div00");
        ...
        // User Script
        this.registerScript("SDIFrameLeft.xfdl", function() {
        /**
        *  Nexacro Professional Training Couse
        *  @MenuPath    SIDFrame > SDIFrameLeft
        *  @FileName 	SDIFrameLeft.xfdl
        *  @Creator 	TOBESOFT Education
        *  @CreateDate 	2025/03/02
        *  @Desction    SDI Main Left Menu
        ************** 소스 수정 이력 ***********************************************
        ...
        */
        ...
        {
        	this.fvTopMenuId = topMenuId;

        	//메뉴 복사
        	this.fnCopyMenu(topMenuId);
        	//첫번째 화면 오픈
        	this.fnOpenFirstMenu();

        };

        this.fnCopyMenu = function(topMenuId)
        {
        ...
        this.fnOpenFirstMenu = function()
        {
        	//Top메뉴 선택시 첫번째 화면 자동 오픈
        	for(var i=0; i<5; i++){
        		var nTreeRow = this.divLeft.form.grdTree.getTreeRow(i);
        		var nStatus = this.divLeft.form.grdTree.getTreeStatus(nTreeRow);
        		if(nStatus != 3){
        			this.divLeft.form.grdTree.setTreeStatus(nTreeRow, 1);
        		}
        		else{
        			this.dsMenu.rowposition = i;
        			this.fnFormOpen(this.dsMenu,i);
        			return;
        		}
        	}
        }
        ...
        */
        this.fnFormOpen = function (objDs,nTargetRow,objArg)
        {
        	...
        	if (this.gfnIsNull(objArg)) objArg = {topmenuid : this.fvTopMenuId};
        ...
        */
        ...
        this.loadIncludeScript("SDIFrameLeft.xfdl");
