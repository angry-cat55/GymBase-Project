if (nexacro.Environment)
{
    ...
    env.on_init = function ()
    {
        ...
        this.set_loadingimage("url(\'imagerc::form/loading.gif\')");
    };
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("AboutAccount", "form", "./AboutAccount/", "session", null, "", "0", "0");
        nexacro._addService("UserForms", "form", "./UserForms/", "session", null, "", "0", "0");
        nexacro._addService("AdminForms", "form", "./AdminForms/", "session", null, "", "0", "0");
        nexacro._addService("MarketForms", "form", "./MarketForms/", "session", null, "", "0", "0");
        nexacro._addService("SuperAdminForms", "form", "./SuperAdminForms/", "session", null, "", "0", "0");
        nexacro._addService("테스트폼들", "form", "./테스트폼들/", "session", null, "", "0", "0");
        nexacro._addService("SvcUrl", "JSP", "http://172.10.14.131:8088/edupack_egov/", "none", null, "", "0", "0");
        nexacro._addService("ExtJs", "js", "./_extlib_/ExtJs/", "session", null, "", "0", "0");
