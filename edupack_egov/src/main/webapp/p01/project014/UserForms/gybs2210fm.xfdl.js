(function()
{
    return function()
    {
        ...
        {
            this.set_name("gybs2210fm");
            this.set_titletext("페이지 칸");
            if (Form == this.constructor)
            {
                this._setFormPosition(930,40);
            }
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",930,40,this,function(p){});
        ...
        // User Script
        this.registerScript("gybs2210fm.xfdl", function() {
        /**
        *  Necacro EduPack
        ...
        */
        ...
        /*     var objDivPaging = this.divPage;*/
            ...
            if (sPageView == "all" || sPageView == "number")
            {
        		...
        		objBtnFirst.cssclass = "btn_WF_PagingDPrev";
        		objBtnFirst.page = 1;
        		...
        		// 현재페이지가 '1'이면 비활성화
        		if( nPage == 1) objBtnBefore.enable = false;
        		...
        		if( nPage >= nTotalPageC) objBtnNext.enable = false;
        		objBtnNext.show();
        		nLeft = nLeft + nWidth + nTermBtn; //left값 계산
        ...
        */
        ...
        this.loadIncludeScript("gybs2210fm.xfdl");
