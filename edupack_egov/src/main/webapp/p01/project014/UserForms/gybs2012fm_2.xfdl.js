(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_gymList","20","230",null,"1250","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj = new ImageViewer("btn_search",null,"130","40","40","20",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Edit("edt_search",null,"130","310","40","btn_search:10",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_borderRadius("20px");
            obj.set_displaynulltext("헬스장 이름을 검색하세요.");
            obj.set_font("normal 12pt/normal \"Arial\"");
            obj.set_padding("0px 0px 0px 20px");
            this.addChild(obj.name, obj);

            obj = new Combo("cbo_sortType",null,"130","120","40","edt_search:10",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_borderRadius("20px");
            obj.set_font("normal 12pt/normal \"Arial\"");
        ...
        // User Script
        this.registerScript("gybs2012fm_2.xfdl", function() {
        ...
        this.fnSearch = function ()
        {
        	...
        	// 검색어
        	var nSearcheTerm = "";
        	if (this.isSearching == true) var nSearcheTerm = this.edt_search.value;
        	...
        	// 최신순 정렬
        	if (this.cbo_sortType.value == "RECENT") {
        		var strSvcUrl = "p014/getRecentGymList.do";
        		var inData    = "ds_search=ds_search";
        		var outData   = "ds_gymList=ds_gymList";
        		var strArg    = "";

        		this.gfnTransaction("getRecentGymList", strSvcUrl, inData, outData, strArg, "fnCallback", true);
        	}

        	// 인기순 정렬
        	else {
        		var strSvcUrl = "p014/getFavoritesGymList.do";
        		var inData    = "ds_search=ds_search";
        		var outData   = "ds_gymList=ds_gymList";
        		var strArg    = "";

        		this.gfnTransaction("getFavoritesGymList", strSvcUrl, inData, outData, strArg, "fnCallback", true);
        	}
        };
        ...
        this.fnCallback = function(svcId, errCd, errMsg) {
        	...
        	if (svcId == "getRecentGymList" || svcId == "getFavoritesGymList") {
        		if (errCd == -1) {
        			this.alert(errMsg);
        			return;
        		}
        ...
        this.loadIncludeScript("gybs2012fm_2.xfdl");
