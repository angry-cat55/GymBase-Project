(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("gybs5011fm.xfdl", function() {
        /**
        *  Necacro EduPack
        ...
        * FORM EVENT 영역(onload)
        ...
        this.Form_onload = function(obj,e)
        {
        	...
        	if (this.gfnIsNull(this.parent.onText) == false)  this.divToggle.form.btnOn.text = this.parent.onText;
        	if (this.gfnIsNull(this.parent.offText) == false) this.divToggle.form.btnOff.text = this.parent.offText;
        ...
        this.fnOn = function()
        {
            this.divToggle.form.btnOff.visible = false;
            this.divToggle.form.btnOn.visible = true;
        	this.divToggle.form.staBG.background = "#31a2de";
        	this.parent.parent.parent.parent.parent.parent.fnToggleChanged();
        ...
        this.fnOff = function()
        {
            this.divToggle.form.btnOff.visible = true;
            this.divToggle.form.btnOn.visible = false;
            this.divToggle.form.staBG.background = "#dddddd";
        	this.parent.parent.parent.parent.parent.parent.fnToggleChanged();
        ...
        this.loadIncludeScript("gybs5011fm.xfdl");
