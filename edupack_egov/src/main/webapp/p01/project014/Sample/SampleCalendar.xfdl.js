(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Calendar("calFrom","551","627","193","28",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            obj.set_popuptype("none");
            obj.set_value("20250705");
            this.addChild(obj.name, obj);

            obj = new Calendar("calTo","806","627","190","28",null,null,null,null,null,null,this);
            obj.set_taborder("40");
            obj.set_popuptype("none");
            obj.set_value("20250721");
            this.addChild(obj.name, obj);

            obj = new Static("sta00","759","610","65","60",null,null,null,null,null,null,this);
            obj.set_taborder("41");
            obj.set_text("~");
            obj.set_font("26px/normal \"Segoe UI\",\"Malgun Gothic\"");
            this.addChild(obj.name, obj);

            obj = new PopupDiv("pdiv00","594","655","344","138",null,null,null,null,null,null,this);
            obj.set_text("");
            obj.set_visible("true");
            obj.set_cssclass("pdiv_WF_Area");
            this.addChild(obj.name, obj);

            obj = new Calendar("calFrom","0","-3","149","117",null,null,null,null,null,null,this.pdiv00.form);
            obj.set_taborder("0");
            obj.set_type("monthonly");
            this.pdiv00.addChild(obj.name, obj);

            obj = new Calendar("calTo","198","-1","144","115",null,null,null,null,null,null,this.pdiv00.form);
            obj.set_taborder("1");
            obj.set_type("monthonly");
            this.pdiv00.addChild(obj.name, obj);

            obj = new Button("btnOk","-1","113","149","23",null,null,null,null,null,null,this.pdiv00.form);
            obj.set_taborder("2");
            obj.set_text("확인");
            this.pdiv00.addChild(obj.name, obj);

            obj = new Button("btnClose","197","113","143","23",null,null,null,null,null,null,this.pdiv00.form);
            obj.set_taborder("3");
            obj.set_text("취소");
            this.pdiv00.addChild(obj.name, obj);

            obj = new Div("div00","105","626","342","137",null,null,null,null,null,null,this);
            obj.set_taborder("42");
            obj.set_text("");
            obj.set_url("Cmm::CmmCalendarFromTo.xfdl");
            this.addChild(obj.name, obj);
        ...
        */
        ...
        // this.pdiv00_btnOk_onclick = function(obj:nexacro.Button,e:nexacro.ClickEventInfo)
        // {
        ...
        this.pdiv00_btnClose_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.pdiv00.form.btnClose.addEventHandler("onclick",this.pdiv00_btnClose_onclick,this);
        };
