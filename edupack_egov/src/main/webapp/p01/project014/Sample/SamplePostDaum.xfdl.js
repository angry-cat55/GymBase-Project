(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_value("1.화면에 Daum의 우편번호 페이지를 호출 할 수 있도록 WebBrowser 컴포넌트를 생성한다.\n2.찾기 버튼 클릭시 공통함수를 호출한다. this.gfnPostSearch(this.webPost);\n3.WebBrowser의 onusernotify함수에서 e.userdata로 넘어온 값을 \":::\"구분자로 잘라서 값을 넣어준다.\n   array[1]=>구우편번호 앞 3자리\n   array[2]=>구우편번호 뒷 3자리\n   array[3]=>신규우편번호\n   array[4]=>도로명주소\n   array[5]=>지번주소\n   array[6]=>조합형 주소여부에 따른 주소");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSculZip","20","txtDesc:20","92","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            this.addChild(obj.name, obj);

            obj = new Edit("edtBasAddr","20","edtSculZip:5","448","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Edit("edtDetAddr","20","edtBasAddr:5",null,"26","549",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_maxlength("200");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearchPost","edtSculZip:5","txtDesc:20","110","26",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new WebView("webPost","784","290","191","114",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new BindItem("item17","edtDetAddr","value","ds_list","DETL_ADDR");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        */
        this.webPost_onusernotify = function(obj,e)
        {
        	...
        	if (strPost.indexOf("OK!!!:::") == 0) {
        		...
        		this.edtSculZip.value = aAddr[3];	// 신규 우편번호
        		this.edtBasAddr.value = aAddr[6];	// 조합형 주소여부에 따른 주소
        	}
        };
        });
