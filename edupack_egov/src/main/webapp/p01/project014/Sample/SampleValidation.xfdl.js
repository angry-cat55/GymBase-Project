(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1020,1340);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsList", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "ID","type" : "STRING","size" : "256"},{"id" : "SSN","type" : "STRING","size" : "256"},{"id" : "DATE_FROM","type" : "STRING","size" : "256"},{"id" : "DATE_TO","type" : "STRING","size" : "256"},{"id" : "MAX_NUM","type" : "FLOAT","size" : "256"},{"id" : "DECIMAL","type" : "BIGDECIMAL","size" : "256"},{"id" : "COMPARE_1","type" : "STRING","size" : "256"},{"id" : "COMPARE_2","type" : "STRING","size" : "256"}]},"Rows" : [{"ID" : "kimyk","DATE_FROM" : "20171101","DATE_TO" : "20171130","MAX_NUM" : "10","DECIMAL" : "1.25","COMPARE_1" : "10","COMPARE_2" : "20"}]});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsList2", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "DATE","type" : "STRING","size" : "256"},{"id" : "EDIT","type" : "STRING","size" : "256"},{"id" : "MAX_NUM","type" : "INT","size" : "256"},{"id" : "MIN_NUM","type" : "INT","size" : "256"},{"id" : "LENGTH_MIN","type" : "STRING","size" : "256"},{"id" : "RANGE","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Grid("grdVali","20","991",null,"160","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("Static01","20","grdVali:20","248","26",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("2) Component Validation Check");
            obj.set_cssclass("sta_WF_Title3");
            this.addChild(obj.name, obj);

            obj = new Div("divVali","20","Static01:5","491","114",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_cssclass("div_WF_Area");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","260","10","71","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("6");
            obj.set_text("필수(Edit)");
            obj.set_cssclass("sta_WF_Title4");
            this.divVali.addChild(obj.name, obj);

            obj = new Edit("edt01","334","10","146","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("5");
            obj.set_cssclass("edt_WF_Essential\n");
            this.divVali.addChild(obj.name, obj);

            obj = new Static("Static08","10","10","71","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("7");
            obj.set_text("필수(날짜)");
            obj.set_cssclass("sta_WF_Title4");
            this.divVali.addChild(obj.name, obj);

            obj = new Calendar("cal","84","10","146","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("4");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_cssclass("cal_WF_Essential");
            this.divVali.addChild(obj.name, obj);

            obj = new Static("Static30","10","41","71","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("8");
            obj.set_text("최대값100");
            obj.set_cssclass("sta_WF_Title4");
            this.divVali.addChild(obj.name, obj);

            obj = new Edit("edtMax","84","41","146","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("3");
            this.divVali.addChild(obj.name, obj);

            obj = new Static("Static29","260","41","71","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("9");
            obj.set_text("최소값10");
            obj.set_cssclass("sta_WF_Title4");
            this.divVali.addChild(obj.name, obj);

            obj = new Edit("edtMin","334","41","146","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("2");
            this.divVali.addChild(obj.name, obj);

            obj = new Static("Static20","10","72","71","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("10");
            obj.set_text("최소길이3");
            obj.set_cssclass("sta_WF_Title4");
            this.divVali.addChild(obj.name, obj);

            obj = new Edit("edtLegthMin","84","72","146","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("1");
            this.divVali.addChild(obj.name, obj);

            obj = new Static("Static54","260","72","71","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("11");
            obj.set_text("범위(1~5)");
            obj.set_cssclass("sta_WF_Title4");
            this.divVali.addChild(obj.name, obj);
            ...
            obj = new Edit("edtRange","334","72","146","26",null,null,null,null,null,null,this.divVali.form);
            obj.set_taborder("0");
            this.divVali.addChild(obj.name, obj);

            obj = new TextArea("txtDesc","20","60",null,"880","20",null,null,null,null,null,this);
            obj.set_taborder("12");
            ...
            obj = new Static("Static00","20","txtDesc:20","220","26",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("1) Grid Validation Check");
            obj.set_cssclass("sta_WF_Title3");
            this.addChild(obj.name, obj);

            obj = new Button("btnGrdCheck","950","957","60","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("체크");
            obj.set_cssclass("btn_WF_FillRed");
            this.addChild(obj.name, obj);

            obj = new Button("btnDivCheck","438","grdVali:20","60","26",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("체크");
            obj.set_cssclass("btn_WF_FillRed");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","560","grdVali:20","298","26",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("3) Grid와 Component Validation Check");
            obj.set_cssclass("sta_WF_Title3");
            this.addChild(obj.name, obj);

            obj = new Button("btnAll","688","Static02:5","60","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("체크");
            obj.set_cssclass("btn_WF_FillRed");
            this.addChild(obj.name, obj);

            obj = new Button("btnAdd","820","957","60","26",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("추가");
            this.addChild(obj.name, obj);

            obj = new Button("btnDel","885","957","60","26",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("삭제");
            this.addChild(obj.name, obj);

            obj = new Radio("rdoGubun","560","Static02:5","100","50",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var rdoGubun_innerdataset = new nexacro.NormalDataset("rdoGubun_innerdataset", obj);
            rdoGubun_innerdataset._setContents({"ColumnInfo" : {"Column" : [ {"id" : "codecolumn","size" : "256"},{"id" : "datacolumn","size" : "256"}]},"Rows" : [{"codecolumn" : "1","datacolumn" : "값으로 체크"},{"codecolumn" : "2","datacolumn" : "길이로 체크"}]});
            ...
            obj = new Panel("Panel00",null,"txtDesc:20","220","26","20",null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_horizontalgap("5");
            obj.set_flexmainaxisalign("end");
            obj._setContents("<Contents><PanelItem id=\"PanelItem00\" componentid=\"btnAdd\"/><PanelItem id=\"PanelItem01\" componentid=\"btnDel\"/><PanelItem id=\"PanelItem02\" componentid=\"btnGrdCheck\"/></Contents>");
            this.addChild(obj.name, obj);
            // Layout Functions
            ...
            //-- Default Layout : this
            obj = new Layout("default","",1020,1340,this,function(p){});
