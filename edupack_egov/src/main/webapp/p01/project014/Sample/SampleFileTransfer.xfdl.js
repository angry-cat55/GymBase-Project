(function()
{
    return function()
    {
        ...
        {
            this.set_name("SampleFileTransfer");
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "fileid","type" : "STRING","size" : "256"},{"id" : "fileimg","type" : "STRING","size" : "256"},{"id" : "filename","type" : "STRING","size" : "256"},{"id" : "filetype","type" : "STRING","size" : "256"},{"id" : "filesize","type" : "INT","size" : "256"},{"id" : "tranfilesize","type" : "INT","size" : "256"},{"id" : "prog","type" : "INT","size" : "256"},{"id" : "dnimg","type" : "STRING","size" : "256"},{"id" : "rmimg","type" : "STRING","size" : "256"},{"id" : "status","type" : "STRING","size" : "256"},{"id" : "filekey","type" : "STRING","size" : "256"},{"id" : "downcnt","type" : "STRING","size" : "256"},{"id" : "filepath","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);


            obj = new Dataset("dsTemp", this);
            obj.set_useclientlayout("true");
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "fileid","type" : "STRING","size" : "256"},{"id" : "filename","type" : "STRING","size" : "256"},{"id" : "filetype","type" : "STRING","size" : "256"},{"id" : "filesize","type" : "INT","size" : "256"}]}});
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btn_add","20","127","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Add Files");
            obj.set_cssclass("btn_WF_FillTeal");
            this.addChild(obj.name, obj);

            obj = new Button("btn_upload","115","127","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("upload");
            obj.set_cssclass("btn_WF_FillTeal");
            this.addChild(obj.name, obj);

            obj = new Grid("grdUpload","20","160","730","340",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Button("btn_deleteAll","210","127","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Delete All");
            obj.set_cssclass("btn_WF_FillTeal");
            this.addChild(obj.name, obj);

            obj = new ProgressBar("ProgressBar","190","250","390","20",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Button("btnFileList","305","127","90","26",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj.set_value("FileUpTransfer, FileDownTransfer 컴포넌트를 활용한 파일 업/다운로드 샘플이다.");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        */
        ...
        this.grdUpload_oncellclick = function(obj,e)
        {
        	...
        	if (e.col == rmCellIdx) {
        		...
        		if (this.gfnIsNull(this.dsUpload.getColumn(e.row, "filesize"))) {
        			this.dsUpload.enableevent = false;
        			this.dsUpload.deleteRow(e.row);
        			this.dsUpload.enableevent = true;
        ...
        //		var encodeFileName = encodeURIComponent(sFilename);
        		...
        		this.FileDownTransfer.downloadfilename = sFilename; // only NRE
        ...
        this.FileUpTransfer_onsuccess = function(obj,e)
        {
        	...
        	*/
        	...
        	if(this.ProgressBar.visible)	this.ProgressBar.visible = false;
        ...
        this.FileUpTransfer_onprogress = function(obj,e)
        {
        	...
        	this.ProgressBar.pos = e.loaded;

        	if (e.total == e.loaded) {
        		this.ProgressBar.pos = 0;
