(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("1");
            obj.set_text("아이디를 찾지 못했습니다.");
            obj.set_font("normal 900 14pt/normal \"Arial\"");
            obj.set_color("black");
            ...
            obj = new Static("sta_inform00","0","sta_inform:0",null,"30","0",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_font("normal bold 12pt/normal \"Arial\"");
            obj.set_textAlign("center");
            obj.set_color("black");
        ...
        // User Script
        this.registerScript("gybs1112pu.xfdl", function() {
        ...
        this.loadIncludeScript("gybs1112pu.xfdl");
