(function()
{
    return function()
    {
        ...
        {
            this.set_name("ImageUpload");
            this.set_titletext("New Form");
            if (Form == this.constructor)
            {
                this._setFormPosition(490,540);
            }
            ...
            obj = new Grid("grd00","30","235","360","270",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_binddataset("dsUser");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row band=\"head\" size=\"24\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"USER_NAME\"/><Cell col=\"1\" text=\"EMAIL\"/><Cell col=\"2\" text=\"TEL_NO\"/><Cell col=\"3\" text=\"IMAGE_ID\"/><Cell col=\"4\" text=\"IMAGE_NAME\"/></Band><Band id=\"body\"><Cell text=\"bind:USER_NAME\"/><Cell col=\"1\" text=\"bind:EMAIL\"/><Cell col=\"2\" text=\"bind:TEL_NO\"/><Cell col=\"3\" text=\"bind:IMAGE_ID\"/><Cell col=\"4\" text=\"bind:IMAGE_NAME\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",490,540,this,function(p){});
        ...
        // User Script
        this.registerScript("ImageUpload.xfdl", function() {
        ...
        this.loadIncludeScript("ImageUpload.xfdl");
