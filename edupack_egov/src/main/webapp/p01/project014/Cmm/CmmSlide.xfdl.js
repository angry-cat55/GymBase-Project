(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divSlide","0","0",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

            obj = new Static("stBarBg","20","43","360","15",null,null,null,null,null,null,this.divSlide.form);
            obj.set_taborder("0");
            obj.set_background("#dddddd");
            obj.set_border("0px none");
            this.divSlide.addChild(obj.name, obj);

            obj = new Static("stBar","20","43","250","15",null,null,null,null,null,null,this.divSlide.form);
            obj.set_taborder("1");
            obj.set_background("#31a2de");
            this.divSlide.addChild(obj.name, obj);

            obj = new Static("stTooltip","251","10","56","22",null,null,null,null,null,null,this.divSlide.form);
            obj.set_taborder("2");
            obj.set_text("0");
            this.divSlide.addChild(obj.name, obj);

            obj = new Static("stMin","20","69","40","25",null,null,null,null,null,null,this.divSlide.form);
            obj.set_taborder("3");
            obj.set_text("0");
            this.divSlide.addChild(obj.name, obj);

            obj = new Static("stMax","359","69","26","25",null,null,null,null,null,null,this.divSlide.form);
            obj.set_taborder("4");
            obj.set_text("99");
            this.divSlide.addChild(obj.name, obj);

            obj = new Button("btnBarPoint","252","35","30","30",null,null,null,null,null,null,this.divSlide.form);
            obj.set_taborder("5");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",400,100,this,function(p){});
        ...
        // User Script
        this.registerScript("CmmSlide.xfdl", function() {
        /**
        *  Necacro EduPack
        ...
        * FORM EVENT 영역(onload)
        ...
        this.fnMoveBarPoint = function(nClientX)
        {
        	...
        	obj.form.stTooltip.text = (this.fvValue + obj.lable);
        }
        ...
        this.loadIncludeScript("CmmSlide.xfdl");
