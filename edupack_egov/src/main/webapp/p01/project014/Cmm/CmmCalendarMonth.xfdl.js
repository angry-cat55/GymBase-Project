(function()
{
    return function()
    {
        ...
        {
            this.set_name("CmmCalendarMonth");
            this.set_titletext("월 달력");
            if (Form == this.constructor)
            {
                this._setFormPosition(96,26);
            }
            ...
            obj = new Calendar("calYM","0","0","100%","26",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("staBg","0","0",null,null,"0","0",null,null,null,null,this.pdvCal.form);
            obj.set_taborder("17");
            ...
            obj.set_font("bold 13px/normal \"Segoe UI\",\"Malgun Gothic\"");
            this.pdvCal.addChild(obj.name, obj);
            ...
            //-- Default Layout : this
            obj = new Layout("default","",96,26,this,function(p){});
        ...
        // User Script
        this.registerScript("CmmCalendarMonth.xfdl", function() {
        /**
        *  Necacro EduPack
        *  @MenuPath    Cmm > CmmCalendarMonth (공통 월달력)
        *  @FileName 	CmmCalendarMonth.xfdl
        *  @Creator 	Education
        ...
        */
        ...
        {
        	if(bValue){
        		this.calYM.cssclass = "cal_WF_Essential";
        	}
        	else{
        		this.calYM.cssclass = "";
        	}
        ...
        */
        ...
        this.loadIncludeScript("CmmCalendarMonth.xfdl");
