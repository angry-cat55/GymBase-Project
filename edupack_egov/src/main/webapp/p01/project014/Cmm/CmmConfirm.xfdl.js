(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnOk",null,null,"70","34","90","9",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("확인");
            ...
            obj = new Button("btnCancle",null,null,"70","34","15","9",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("취소");
            ...
            obj.set_background("url(\'imagerc::form/check.png\') no-repeat center center /contain");
            this.addChild(obj.name, obj);
