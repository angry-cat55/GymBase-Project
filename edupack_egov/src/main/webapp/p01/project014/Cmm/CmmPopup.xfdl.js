(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnClose","42.19%",null,"80","26",null,"8",null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("close");
            obj.set_cssclass("btn_WF_FillGray");
            this.addChild(obj.name, obj);

            obj = new Div("divForm","0","0",null,null,"0","50",null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);

            obj = new Button("btn00","10",null,"80","26",null,"10",null,null,null,null,this);
            obj.set_taborder("2");
        ...
        * FORM EVENT 영역(onload)
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	if( !this.gfnIsNull(this.getOwnerFrame().paramUrl)){
        		this.divForm.url = this.getOwnerFrame().paramUrl;
        	}
        };
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.addEventHandler("oninit",this.CmmPopup_oninit,this);
