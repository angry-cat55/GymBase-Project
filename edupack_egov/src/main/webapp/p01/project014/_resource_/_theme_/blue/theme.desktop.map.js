(function()
{
	return function()
	{
            					...
            					},
            					{
            						"rememberPW" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/GymBase/unShow_PW.png')"),
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"mouseover" :
            					...
            					},
            					{
            						"rememberPW_S" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/GymBase/show_PW.png')"),
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("0px")
            								},
            								"mouseover" :
            						...
            						"GB_Login" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"font" : nexacro.FontObject("normal bold 11pt/normal \"Arial\"")
            								},
            								"disabled" :
            								{
            									"color" : nexacro.ColorObject("white"),
            					...
            					},
            					{
            						"GB_Cancel" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#848484"),
            									"font" : nexacro.FontObject("normal bold 11pt/normal \"Arial\"")
            								},
            								"disabled" :
            								{
            					...
            					},
            					{
            						"menu" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"font" : nexacro.FontObject("normal 900 10pt/normal \"normal/normal\""),
            					...
            					},
            					{
            						"GB_Button" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#000000"),
            									"font" : nexacro.FontObject("normal 600 12pt/normal \"맑은 고딕\"")
            								},
            								"disabled" :
            								{
            									"color" : nexacro.ColorObject("#000000"),
            					...
            					},
            					{
            						"txt_POP_Message" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("20px 20px 0px 70px"),
            									"font" : nexacro.FontObject("normal 500 10pt/normal \"맑은 고딕\""),
            									"color" : nexacro.ColorObject("#000000")
            								},
            								"mouseover" :
            								{
            											...
            											"parent" :
            											{
            												"Grid" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															"color" : nexacro.ColorObject("royalblue"),
            															"border" : nexacro.BorderObject("1px solid #dbdee2"),
            															"padding" : nexacro.PaddingObject("4px 4px 4px 4px")
            														}
            													}
            				...
            				[
            					{
            						"sta_TF_PushCount" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("normal 11pt/normal \"Malgun Gothic\"")
            								}
            							}
            						}
            					}
            				...
            				[
            					{
            						"loginDiv" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid black")
            								}
            							}
            						}
            					}
        ...
        imgcache[nexacro._getImageLocation("theme://images/btn_WF_PagingNext.png")] = { width:6, height:9 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/GymBase/unShow_PW.png")] = { width:30, height:30 };
        		imgcache[nexacro._getImageLocation("theme://images/GymBase/show_PW.png")] = { width:30, height:30 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/GymBase/로고.png")] = { width:796, height:262 };
        		imgcache[nexacro._getImageLocation("theme://images/GymBase/로고_220x70.png")] = { width:220, height:70 };
        		imgcache[nexacro._getImageLocation("theme://images/happy.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/heart.png")] = { width:16, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/invalid1.png")] = { width:24, height:24 };
