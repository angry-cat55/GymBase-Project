(function()
{
    return function()
    {
        ...
        {
            this.set_name("CmmCalendarFromTo");
            this.set_titletext("기간달력");
            if (Form == this.constructor)
            {
                this._setFormPosition(256,26);
            }
            ...
            obj = new Calendar("calFrom","0","0","46.51%","26",null,null,"120",null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Calendar("calTo","Static00:5","0","46.51%","26",null,null,"120",null,null,null,this);
            obj.set_taborder("0");
            obj.set_popuptype("none");
            obj.set_dateformat("yyyy-MM-dd");
            this.addChild(obj.name, obj);

            obj = new PopupDiv("pdvCal","0","30","430","280",null,null,null,null,null,null,this);
            ...
            obj = new Calendar("pdvCalFrom","10","10","200","220",null,null,null,null,null,null,this.pdvCal.form);
            obj.set_taborder("2");
            obj.set_dateformat("yyyy-MM-dd");
            ...
            obj = new Calendar("pdvCalTo","220","10","200","220",null,null,null,null,null,null,this.pdvCal.form);
            obj.set_taborder("1");
            obj.set_dateformat("yyyy-MM-dd");
            obj.set_editformat("yyyy-MM-dd");
            obj.set_type("monthonly");
            ...
            obj = new Button("btnPdvConfirm","150","241","60","28",null,null,null,null,null,null,this.pdvCal.form);
            obj.set_taborder("4");
            obj.set_text("확인");
            ...
            obj = new Button("btnPdvCancle","220","241","60","28",null,null,null,null,null,null,this.pdvCal.form);
            obj.set_taborder("3");
            obj.set_text("취소");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",256,26,this,function(p){});
        ...
        // User Script
        this.registerScript("CmmCalendarFromTo.xfdl", function() {
        /**
        *  Necacro EduPack
        *  @MenuPath    Cmm > CmmCalendarFromTo (공통 기간달력)
        *  @FileName 	CmmCalendarFromTo.xfdl
        *  @Creator 	Education
        ...
        */
        this.calFrom_ondropdown = function(obj,e)
        {
        	...
        	if (this.gfnIsNull(this.calTo.value)) {
        		this.pdvCal.form.pdvCalTo.value = sDate;
        	}
        	else {
        ...
        */
        ...
        this.loadIncludeScript("CmmCalendarFromTo.xfdl");
