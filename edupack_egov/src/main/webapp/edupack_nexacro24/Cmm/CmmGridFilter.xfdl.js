(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "code","type" : "STRING","size" : "256"},{"id" : "name","type" : "STRING","size" : "256"}]},"Rows" : [{},{"code" : "=","name" : "같은"},{"code" : ">","name" : "보다 큰"},{"code" : "<","name" : "보다 작은"},{"code" : "!=","name" : "같지않는"},{"code" : "like","name" : "포함하는"},{"code" : "nolike","name" : "포함하지 않는"}]});
            ...
            obj.set_loadfiltermode("keep");
            obj.set_reversesubsum("false");
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "title","type" : "STRING","size" : "256"},{"id" : "col","type" : "INT","size" : "256"},{"id" : "body","type" : "STRING","size" : "256"},{"id" : "filtertype","type" : "STRING","size" : "256"},{"id" : "displaytype","type" : "STRING","size" : "256"},{"id" : "edittype","type" : "STRING","size" : "256"},{"id" : "combodatacol","type" : "STRING","size" : "256"},{"id" : "combocodecol","type" : "STRING","size" : "256"},{"id" : "combodataset","type" : "STRING","size" : "256"},{"id" : "filtervalue","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            
            // UI Components Initialize
            obj = new Grid("grd00","11","45","449","220",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("dsFilter");
            obj.set_autofittype("col");
            obj.getSetter("griduserproperty").set("!sort,!rowfix,!colfix,!filter,!initial");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"122\"/><Column size=\"155\"/><Column size=\"168\"/></Columns><Rows><Row size=\"28\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"컬럼명\" expandchar=\"popup.columnname\"/><Cell col=\"1\" text=\"필터기준\" expandchar=\"popup.filtercriteria\"/><Cell col=\"2\" text=\"찾을조건\" expandchar=\"popup.findcondition\"/></Band><Band id=\"body\"><Cell text=\"bind:title\" displaytype=\"text\" edittype=\"none\" combodataset=\"dsFilterCol\" combodatacol=\"columnName\" combocodecol=\"columnId\"/><Cell col=\"1\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"dsFilterType\" combodatacol=\"name\" combocodecol=\"code\" text=\"bind:filtertype\"/><Cell col=\"2\" text=\"bind:filtervalue\" displaytype=\"editcontrol\" edittype=\"text\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btnFilterCancel","255","270","75","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("필터취소");
            ...
            obj = new Button("btnUp","402","16","23","26",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_textPadding("0px");
            obj.set_padding("0px");
            obj.set_cssclass("btn_WF_BaseT");
            this.addChild(obj.name, obj);

            obj = new Button("btnDown","433","16","23","26",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_textPadding("0px");
            obj.set_padding("0px");
            obj.set_cssclass("btn_WF_BaseB");
            this.addChild(obj.name, obj);

            obj = new Button("btnSetFilter","335","270","60","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("적용");
            ...
            obj = new Button("btnClose","400","270","60","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("닫기");
