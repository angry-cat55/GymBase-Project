(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1020,1140);
            }
            
            // Object(Dataset, ExcelExportObject) Initialize
            obj = new Dataset("dsSample", this);
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "Column0","type" : "STRING","size" : "256"},{"id" : "Column1","type" : "STRING","size" : "256"},{"id" : "Column2","type" : "STRING","size" : "256"},{"id" : "Column3","type" : "INT","size" : "256"}]},"Rows" : [{"Column0" : "color","Column1" : "warm","Column2" : "red","Column3" : "1"},{"Column0" : "color","Column1" : "warm","Column2" : "yellow","Column3" : "1200"},{"Column0" : "color","Column1" : "cool","Column2" : "blue","Column3" : "3"},{"Column0" : "color","Column1" : "cool","Column2" : "navy","Column3" : "4"},{"Column0" : "fruits","Column1" : "acid","Column2" : "lemon","Column3" : "5"},{"Column0" : "fruits","Column1" : "acid","Column2" : "orange","Column3" : "1600"},{"Column0" : "fruits","Column1" : "sweet","Column2" : "test","Column3" : "7"},{"Column0" : "fruits","Column1" : "sweet","Column2" : "strawberry","Column3" : "8"},{"Column0" : "fruits","Column1" : "sweet","Column2" : "banana","Column3" : "9"}]});
            ...
            obj.set_value("1. Suppress - 그리드의 row값이 같을 경우 하나의 값으로 표현해주는 기능\n2. 소계, 합계 - 그리드 소계, 합계 처리 샘플\n3. Auto Size - Grid Column, Row Auto Size 설정 샘플");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","20","txtDesc:20","258","40",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("1) Suppress");
            obj.set_cssclass("sta_WF_Title3");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00","20","Static00:0","273","378",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Static("Static01","303","txtDesc:20","218","40",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("2) 소계,합계");
            obj.set_cssclass("sta_WF_Title3");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01","303","Static01:0","352","378",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Static("Static02","20","Grid00:20","278","40",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("3) Auto Size");
            obj.set_cssclass("sta_WF_Title3");
            this.addChild(obj.name, obj);

            obj = new Grid("grd00","20","Static02:0","980","162",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Grid("grd01","20","grd00:10",null,"302","20",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_binddataset("dsSize");
            ...
            obj = new Button("btnSubRowHidden","665","txtDesc:28","157","24",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("소계 ROW 표시안하기");
            obj.set_cssclass("btn_WF_Exec");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid02","668","btnSubRowHidden:8","332","378",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_binddataset("dsSample00");
            obj.set_autofittype("col");
            obj.set_selecttype("row");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1020,1140,this,function(p){});
