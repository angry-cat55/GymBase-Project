(function()
{
    return function()
    {
        ...
        this.CheckBoxSet01_canitemchange = function(obj,e)
        {

        };

        this.CheckBoxSet01_onitemchanged = function(obj,e)
        {
        	trace(this.CheckBoxSet01.value);
        };
        ...
        {
            this.CheckBoxSet01.addEventHandler("canitemchange",this.CheckBoxSet01_canitemchange,this);
            this.CheckBoxSet01.addEventHandler("onitemchanged",this.CheckBoxSet01_onitemchanged,this);
