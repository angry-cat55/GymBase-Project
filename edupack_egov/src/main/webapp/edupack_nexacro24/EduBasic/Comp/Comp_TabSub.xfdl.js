(function()
{
    return function()
    {
        ...
        {
            this.set_name("Comp_TabSub");
            this.set_titletext("Comp_TabSub");
            this.set_background("#fafaff");
            if (Form == this.constructor)
            {
                this._setFormPosition(470,410);
            }
            ...
            obj = new Static("Static00","10.00","0","285","35",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Button("Button00","10.00","245","295","26",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("this.parent.parent.parent.Edit00.value");
            obj.set_positionstep("0");
            obj.set_cssclass("btn_WF_GuideExec");
            this.addChild(obj.name, obj);

            obj = new TextArea("txt_desc","10.00","276","450","124",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_positionstep("0");
            ...
            obj = new Edit("Edit00","10","167","130","26",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01","300.00","7","162","26",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("form id = \"Comp_TabSub\"");
            obj.set_cssclass("sta_WF_GuideRefer");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",470,410,this,function(p){});
            obj.set_stepcount("0");
        ...
        // User Script
        this.registerScript("Comp_TabSub.xfdl", function() {
        this.fn_exec = function(obj,e)
        {
        	...
        	switch(obj.text) {
        		case 'this.parent.parent.parent.Edit00.value':
        			strDesc = `"this" : ${this} : ${this.name}
			           "this.parent" : ${this.parent} : ${this.parent.name}
        					   ...
        					   "this.parent.parent.parent" : ${this.parent.parent.parent} : ${this.parent.parent.parent.name}
        					   ${obj.text} : ${this.parent.parent.parent.Edit00.value}`
			break;
        		default:
        			break;
        	}
        ...
        this.loadIncludeScript("Comp_TabSub.xfdl");
