(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "col_0","type" : "STRING","size" : "256"},{"id" : "col_1","type" : "INT","size" : "256"},{"id" : "col_2","type" : "FLOAT","size" : "256"},{"id" : "col_3","type" : "DATE","size" : "256"},{"id" : "col_4","type" : "TIME","size" : "256"},{"id" : "col_5","type" : "DATETIME","size" : "256"},{"id" : "col_6","type" : "BIGDECIMAL","size" : "256"}]}});
            ...
            obj._setContents({"ColumnInfo" : {"Column" : [ {"id" : "TIME","type" : "STRING","size" : "256"},{"id" : "MES","type" : "STRING","size" : "256"}]}});
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"col_0\"/><Cell col=\"2\" text=\"col_1\"/><Cell col=\"3\" text=\"col_2\"/><Cell col=\"4\" text=\"col_3\"/><Cell col=\"5\" text=\"col_4\"/><Cell col=\"6\" text=\"col_5\"/><Cell col=\"7\" text=\"col_6\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\"/><Cell col=\"1\" text=\"bind:col_0\"/><Cell col=\"2\" text=\"bind:col_1\"/><Cell col=\"3\" text=\"bind:col_2\"/><Cell col=\"4\" text=\"bind:col_3\"/><Cell col=\"5\" text=\"bind:col_4\"/><Cell col=\"6\" text=\"bind:col_5\"/><Cell col=\"7\" text=\"bind:col_6\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"127\"/><Column size=\"341\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"TIME\"/><Cell col=\"1\" text=\"MES\"/></Band><Band id=\"body\"><Cell text=\"bind:TIME\"/><Cell col=\"1\" text=\"bind:MES\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        //	this.Dataset00.firefirstcount = first;
        //	this.Dataset00.firenextcount = next;
        	var strUrl = "EduUrl::Firstrow.jsp?First="+first+"&Next="+next+"&Count="+total+"&Sleep="+sleep;
