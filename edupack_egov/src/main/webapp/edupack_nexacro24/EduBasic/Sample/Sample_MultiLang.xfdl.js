(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("0");
            obj.set_text("TEXT(\"employee.management\",\"사원 관리\")");
            obj.set_cssclass("sta_WF_GuideTitle1");
            this.addChild(obj.name, obj);

            obj = new Button("btn_save",null,"12","50","26","10",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("TEXT(\"action.save\",\"저장\")");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_delete",null,"12","50","26","btn_save:5",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("TEXT(\"action.delete\",\"삭제\")");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Button("btn_add",null,"12","50","26","btn_delete:5",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("TEXT(\"action.add\",\"입력\")");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_retrieve",null,"12","50","26","btn_add:5",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("TEXT(\"action.retrieve\",\"조회\")");
            obj.set_cssclass("btn_WF_CRUD");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static00","0","9","74","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            obj.set_text("TEXT(\"dept\",\"부서\")");
            obj.set_cssclass("sta_WF_SchLabel");
            obj.set_fittocontents("width");
            this.div_search.addChild(obj.name, obj);

            obj = new Edit("edt_deptCode","Static00:0","9","90","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_text("");
            this.div_search.addChild(obj.name, obj);

            obj = new Button("btn_findDept","Static00:60","8","28","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_Find");
            this.div_search.addChild(obj.name, obj);

            obj = new Edit("edt_deptName","Static00:88","9","170","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_readonly("true");
            obj.set_text("");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("Static01","edt_deptName:0","9","74","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("6");
            obj.set_text("TEXT(\"name\",\"성명\")");
            obj.set_cssclass("sta_WF_SchLabel");
            obj.set_fittocontents("width");
            this.div_search.addChild(obj.name, obj);

            obj = new Edit("edt_empName","Static01:0","9","130","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("7");
            this.div_search.addChild(obj.name, obj);

            obj = new Static("Static02","edt_empName:0","9","74","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("4");
            obj.set_text("TEXT(\"gender\",\"성별\")");
            obj.set_cssclass("sta_WF_SchLabel");
            obj.set_fittocontents("width");
            this.div_search.addChild(obj.name, obj);

            obj = new Radio("rdo_gender","Static02:0","9","220","26",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("5");
            ...
            obj = new Static("Static01","10","94","158","40",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("TEXT(\"employee.list\",\"사원 목록\")");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"48\"/><Column size=\"90\"/><Column size=\"80\"/><Column size=\"150\"/><Column size=\"150\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"60\"/><Column size=\"70\"/><Column size=\"150\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/><Row size=\"24\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"TEXT(&quot;name&quot;,&quot;성명&quot;)\"/><Cell col=\"2\" text=\"TEXT(&quot;employee.id&quot;,&quot;사원번호&quot;)\"/><Cell col=\"3\" text=\"TEXT(&quot;dept.name&quot;,&quot;부서명&quot;)\"/><Cell col=\"4\" text=\"TEXT(&quot;employee.positoin&quot;,&quot;직급&quot;)\"/><Cell col=\"5\" text=\"TEXT(&quot;employee.positoin&quot;,&quot;입사일자&quot;)\"/><Cell col=\"6\" text=\"TEXT(&quot;salary&quot;,&quot;급여&quot;)\"/><Cell col=\"7\" text=\"TEXT(&quot;gender&quot;,&quot;성별&quot;)\"/><Cell col=\"8\" text=\"TEXT(&quot;married&quot;,&quot;결혼여부&quot;)\"/><Cell col=\"9\" text=\"TEXT(&quot;skill&quot;,&quot;보유스킬&quot;)\"/></Band><Band id=\"body\"><Cell text=\"expr:currow + 1\" displaytype=\"text\"/><Cell col=\"1\" text=\"bind:EMP_NAME\" edittype=\"normal\"/><Cell col=\"2\" text=\"bind:EMP_ID\" displaytype=\"mask\" edittype=\"mask\" maskedittype=\"string\" maskeditformat=\"AA-###\"/><Cell col=\"3\" text=\"bind:DEPT_CODE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_dept\" combocodecol=\"DEPT_CODE\" combodatacol=\"DEPT_NAME\"/><Cell col=\"4\" text=\"bind:POSITION\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"ds_pos\" combocodecol=\"CODE\" combodatacol=\"NAME\"/><Cell col=\"5\" text=\"bind:HIRE_DATE\" displaytype=\"date\" edittype=\"date\"/><Cell col=\"6\" text=\"bind:SALARY\" displaytype=\"mask\" edittype=\"mask\" maskeditformat=\"#,#\"/><Cell col=\"7\" text=\"expr:GENDER == &quot;M&quot; ? &quot;Male&quot; : &quot;Female&quot;\" displaytype=\"text\"/><Cell col=\"8\" text=\"bind:MARRIED\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"9\" text=\"bind:SKILL\" displaytype=\"multicombocontrol\" edittype=\"multicombo\" multicombodataset=\"ds_skill\" multicombocodecol=\"CODE\" multicombodatacol=\"NAME\"/></Band><Band id=\"summary\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\" text=\"expr:TEXT(&quot;salary&quot;,&quot;급여&quot;) + &quot; &quot; + TEXT(&quot;avg&quot;,&quot;평균&quot;)\"/><Cell col=\"6\" text=\"expr:nexacro.round(dataset.getAvg(&quot;SALARY&quot;), 2)\" displaytype=\"number\" maskeditformat=\"#,#.00\"/><Cell col=\"7\"/><Cell col=\"8\"/><Cell col=\"9\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("div_detail","10",null,null,"284","10","10","1000",null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Div00");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("2");
            obj.set_text("TEXT(\"employee.id\",\"사원번호\")");
            obj.set_cssclass("sta_WF_DetailLabel");
            this.div_detail.addChild(obj.name, obj);
            ...
            obj = new CheckBox("chk_married","rdo_gender:-11","75","112","26",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("22");
            obj.set_text("TEXT(\"married\",\"결혼여부\")");
            ...
            obj = new Static("Static02","10","366","158","40",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("TEXT(\"detail\",\"상세정보\")");
            obj.set_cssclass("sta_WF_GuideTitle2");
            this.addChild(obj.name, obj);

            obj = new Button("btn_kr",null,"12","80","26","283",null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("한국어");
            obj.set_cssclass("btn_WF_FillTeal");
            this.addChild(obj.name, obj);

            obj = new Button("btn_en",null,"12","70","26","btn_kr:-5",null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("English");
            obj.set_cssclass("btn_WF_LineTeal");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.addIncludeScript("Sample_MultiLang.xfdl","Lib::Lib_Common.xjs");
        this.registerScript("Sample_MultiLang.xfdl", function() {
        ...
        this.btn_kr_onclick = function(obj,e)
        {
        //	this.locale = "ko_KR";
        	this.locale = "ko";
        ...
        this.btn_en_onclick = function(obj,e)
        {
        //	this.locale = "en_US";
        	this.locale = "en";
        ...
        this.on_initEvent = function()
        {
            ...
            this.btn_kr.addEventHandler("onclick",this.btn_kr_onclick,this);
            this.btn_en.addEventHandler("onclick",this.btn_en_onclick,this);
        };
        this.loadIncludeScript("Sample_MultiLang.xfdl");
