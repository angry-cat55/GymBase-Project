(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("Form_ScriptSample1_copy0.xfdl","Lib::Lib_Util.xjs");
        this.addIncludeScript("Form_ScriptSample1_copy0.xfdl","Lib::Lib_Grid.xjs");
        this.addIncludeScript("Form_ScriptSample1_copy0.xfdl","Lib::Lib_Comm.xjs");
        this.addIncludeScript("Form_ScriptSample1_copy0.xfdl","Lib::Lib_Test.xjs");
        this.registerScript("Form_ScriptSample1_copy0.xfdl", function() {
        ...
        this.executeIncludeScript("Lib::Lib_Test.xjs"); /*include "Lib::Lib_Test.xjs"*/;
        ...
        this.Form_onload = function(obj,e)
        {
        	...
        	this.div_search.form.cal_from.value = this.lfn_getFirstDay();
        	this.div_search.form.cal_to.value = this.lfn_getToday();
        	// 코드 데이터 가져오기 - 직급, 재직상태
        	// 직급
            var sSvcID    = "svcCode";
            var sURL      = "EduUrl::getCode.jsp";
            var sInDs     = "";
        ...
        {
        	var sMsg = this.lfn_getMsg("confirm.before.deletesave");
        ...
        this.btn_save_onclick = function(obj,e)
        {
            for(var i=0; i<this.ds_emp.rowcount; i++){
        		...
        		if(this.lfn_isNull(sName)){
        			this.alert("msg.err.validator.required", ["성명"]);
        	...
        	this.transaction(sSvcID, sURL, sInDs, sOutDs, sParam, sCallBack, true, 2);
        ...
        this.div_detail_btn_popupDept_onclick = function(obj,e)
        {
        	...
        	objChild.formurl = "EduBasic::Form/Popup_SearchDept.xfdl";
        ...
        this.loadIncludeScript("Form_ScriptSample1_copy0.xfdl");
