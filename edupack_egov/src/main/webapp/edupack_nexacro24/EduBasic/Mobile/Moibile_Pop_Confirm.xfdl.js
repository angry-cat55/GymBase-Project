(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_cancel","30","181","165","60",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("취소");
            obj.set_cssclass("btn_POP_Cancel");
            this.addChild(obj.name, obj);

            obj = new Button("btn_ok","205","181","165","60",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("확인");
