(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn_intro","20","146","210","164",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Web View");
            obj.set_cssclass("btn_MF_MnuWeb");
            this.addChild(obj.name, obj);

            obj = new Button("btn_camera","250","146","210","164",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Camera");
            obj.set_cssclass("btn_MF_MnuCamera");
            this.addChild(obj.name, obj);

            obj = new Button("btn_component","250","330","210","164",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("btn_MF_MnuComp");
            obj.set_text("Component");
            this.addChild(obj.name, obj);

            obj = new Button("btn_mlm","20","330","210","164",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("MLM");
            obj.set_cssclass("btn_MF_MnuMLM");
            this.addChild(obj.name, obj);

            obj = new Button("btn_listview","20","513","210","164",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("ListView");
            obj.set_cssclass("btn_MF_MnuListView");
            this.addChild(obj.name, obj);

            obj = new Button("btn_step","250","513","210","164",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Step");
            obj.set_cssclass("btn_MF_MnuStep");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        this.btn_iconClick = function(obj,e)
        {
        	...
        	case "btn_listview":	//Listview
        		sUrl = "EduBasic::Mobile/Mobile_ListView.xfdl";
        		//sUrl = "EduBasic::Mobile/Mobile_ListView.xfdl";
        		this.objApp.av_WorkFrame.form.fn_action(sUrl);
        		break;
        	default:
        	...
        	//상단 text 설정
        	this.objApp.av_WorkFrame.form.div_top.form.sta_sub_title.text = obj.text;
