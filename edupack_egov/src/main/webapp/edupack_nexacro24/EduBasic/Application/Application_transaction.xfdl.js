(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Radio("rdo_gender","553","15","252","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
        ...
        // User Script
        this.addIncludeScript("Application_transaction.xfdl","Lib::Lib_Common.xjs");
        this.registerScript("Application_transaction.xfdl", function() {
        ...
        this.loadIncludeScript("Application_transaction.xfdl");
