(function()
{
    return function()
    {
        ...
        {
            this.set_name("Work_Layout");
            this.set_titletext("New Form");
            if (Form == this.constructor)
            {
                this._setFormPosition(830,720);
            }
            ...
            //-- Default Layout : this
            obj = new Layout("default","",830,720,this,function(p){});
        ...
        // User Script
        this.registerScript("Work_Layout.xfdl", function() {
        ...
        this.loadIncludeScript("Work_Layout.xfdl");
