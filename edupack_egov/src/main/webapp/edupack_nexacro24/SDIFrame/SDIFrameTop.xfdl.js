(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divTopBtn","248","0",null,"49","258",null,null,null,null,null,this);
            obj.set_taborder("1");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staPushCount",null,"8","14","14","213",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("3");
        ...
        */
        ...
        this.fnSetName = function()
        {
        	...
        	this.staName.text = ("교육사업팀 " + sName);	//다국어 처리 안함
        };
        ...
        this.fnSetTopMenu = function ()
        {
        	...
        	for(var i=0; i<this.dsMenu.getRowCount(); i++){
        		...
        		var objSize = nexacro.getTextSize(sMenuName, "bold 14px 'Malgun Gothic'");
        		var objBtn = new Button();
        		objBtn.init("btnTop" + sMenuId, nLeft, 0, objSize.nx, "100%");
        		this.divTopBtn.addChild(objBtn.name, objBtn);
        		objBtn.text = sMenuName;
        		...
        		nLeft += (objBtn.getOffsetWidth() + 50);
        ...
        */
        ...
        this.fnSetNoticeShow = function(objForm, bShow, bAni)
        {
        	...
        	if (bShow){
        		...
        		objForm.divNotice.form.staNotice.text = ("공지사항입니다.");	//알림내용
        	}
        	else{
        ...
        this.staPushCount_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.staPushCount.addEventHandler("onclick",this.staPushCount_onclick,this);
