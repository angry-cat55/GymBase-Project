(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divFrameTop","0","0",null,"50","0",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_url("SDIFrame::SDIFrameTop.xfdl");
            this.addChild(obj.name, obj);

            obj = new Div("divFrameLeft","10","60","228",null,null,"10",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_url("SDIFrame::SDIFrameLeft.xfdl");
            this.addChild(obj.name, obj);

            obj = new Div("divFrameWork","divFrameLeft:10","60",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("");
            obj.set_background("#ffffff");
            obj.set_url("SDIFrame::SDIFrameMainForm.xfdl");
            obj.set_async("false");
            obj.set_border("1px solid #d6dee3");
            this.addChild(obj.name, obj);
