if (nexacro.Environment)
{
    ...
    {
        this.set_themeid("theme::theme_edu");
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("EduUrl", "JSP", "http://localhost:8088/edupack_egov/edu/edupack24_jsp/", "none", null, "", "0", "0");
        nexacro._addService("EduUrlServer", "JSP", "http://demo.nexacro.com/edu/edupack24_jsp/", "none", null, "", "0", "0");
        nexacro._addService("EduUrlLocal", "JSP", "http://localhost:8088/edupack_egov/edu/edupack24_jsp/", "none", null, "", "0", "0");
        ...
        nexacro._addService("SvcXpushURL", "JSP", "http://localhost:8088/edupack_egov/edu/xpush_jsp/", "none", null, "", "0", "0");
        ...
        var registerclass = [
        		...
        		{"id":"Phone", "classname":"nexacro.Phone", "type":"JavaScript"},
    ...
    env.on_loadVariables = function ()
    {
        ...
        // Cookies
        nexacro.setCookieVariable("env_cookie1", "Cookie Value1", "false");
        nexacro.setCookieVariable("env_cookie2", "Cookie Value2", "true");
        // HTTP Header
        nexacro.setHTTPHeaderVariable("env_header1", "HTTP Header Value1");
        nexacro.setHTTPHeaderVariable("env_header2", "HTTP Header Value2");
    };
    ...
    {
    	return { "en":true, "ko":true, "ar":true };
    };
