(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staBgLine",null,"0","91",null,"10","0",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_MDI_Line");
            obj.set_border("0px none,0px none,1px solid #d6dee3");
            ...
            obj = new Tab("tabMdi","0","9",null,"31","101",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_tabindex("0");
            obj.set_showextrabutton("true");
            obj.set_cssclass("tab_MDI_Tab");
            obj.set_tabbuttonstartgap("30");
            ...
            obj = new Button("btnMain","0","9","31","31",null,null,null,null,null,null,this);
            obj.set_taborder("7");
        ...
        * FORM EVENT 영역(onload)
        ...
        this.tabMdi_onchanged = function(obj,e)
        {
        	...
        	this.fvObjApp.avVFrameSet1.separatesize = this.fvObjApp.avWorkOpen;
        };
        ...
        this.fnFormClose = function(sFormId, nTabIndex)
        {
        	...
        	if(this.tabMdi.getTabpageCount() == 0)	this.fvObjApp.avVFrameSet1.separatesize = this.fvObjApp.avMainOpen;
        ...
        this.fnArrangeWin = function(strType)
        {
        	...
        	switch (strType)
        	{
        		case "maximize" :
        			...
        			{
        				this.fvObjApp.avWorkFrame.frames[i].openstatus = "maximize";
        				this.fvObjApp.avWorkFrame.frames[i].showtitlebar = false;
        				this.fvObjApp.avWorkFrame.frames[i].border = "0px none";
        			}
        			break;
        		...
        		default :
        			...
        			for (var i=0; i<iFramesCnt; i++)
        			{
        				this.fvObjApp.avWorkFrame.frames[i].showtitlebar = true;
        				this.fvObjApp.avWorkFrame.frames[i].border = "1px solid #7f7f7b";
        				this.fvObjApp.avWorkFrame.frames[i].borderRadius = "3px 3px";
        				this.fvObjApp.avWorkFrame.frames[i].openstatus = "normal";
        				this.fvObjApp.avWorkFrame.frames[i].titlebar.closebutton.enable = false;
        			}
        ...
        {
        	this.fvObjApp.avVFrameSet1.separatesize = this.fvObjApp.avMainOpen;
        };

        this.tabMdi_onsetfocus = function(obj,e)
        {
        	if(obj.getTabpageCount() > 0){
        		this.fvObjApp.avVFrameSet1.eparatesize = this.fvObjApp.avWorkOpen;
        	}
        };
        ...
        this.btnTopChange_onclick = function(obj,e)
        {
        	if(obj.cssclass == "btn_MDI_Collapse"){
        		obj.cssclass = "btn_MDI_Expand";
        		this.fvObjApp.avVFrameSet.separatesize = "0,1,*";
        	}
        	else{
        		obj.cssclass = "btn_MDI_Collapse";
